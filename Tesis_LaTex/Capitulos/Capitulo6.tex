...
%			\end{table}
	...
	A partir del entrenamiento resultante de los tres modelos, RF, VSM y GBR, se ejecuta un test comparativo, ejecutando pronósticos sobre secuencias de datos adquiridos durante campañas de prospección, por lo que no forman parte del conjunto de entrenamiento.
