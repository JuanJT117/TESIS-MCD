...
%			\end{table}
	...
	A partir del entrenamiento resultante de los tres modelos, RF, VSM y GBR, se ejecuta un test comparativo de pronósticos, en este proceso se emplean datos adquiridos en campañas de prospección, cuyos resultados de inversión integran los modelos de unidades de resistividad  empleados en la etapa de generación de modelos sintéticos de respuesta geoeléctrica de los cuales se iteraron variaciones para generar un volumen apropiado de datos de entrenamiento.
	
	
	
	Para poder evaluar la capacidad de pronostico de cada modelo para el mimo conjunto de datos, se acoplan los pronósticos del mismo 
	
	\paragraph{Sondeo 1 Exploración Geohidrológica los Olivos (S1-EGH-OLIVOS)} datos correspondientes a SEV en Lampazos del naranjo, sitio no integrado en el entrenamiento
	...
	\paragraph{Sondeo 1 Lampazo Del Naranjo EBSA (S1-LN-EBSA)} datos correspondientes a SEV en Lampazos del naranjo, sitio no integrado en el entrenamiento
	...
	\end{figure}
		...
		\paragraph{Sondeo 2 Lampazo Del Naranjo EBSA (S2-LN-EBSA)} datos correspondientes a SEV en Lampazos del naranjo, sitio no integrado en el entrenamiento
