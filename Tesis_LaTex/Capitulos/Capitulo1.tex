...
Establecidas las variaciones, se simular la respuesta eléctrica de cada SEV-sintético, obteniendo como resultado un set compuesto por 75000 registros de resistividad aparente.% los cuales se clasifican y compara el comparan copn las distribuciones estadisticas de los datos original
