...
\usepackage{booktabs}   % Para las líneas de tabla profesionales
\usepackage{caption}    % Para personalizar los captions
\usepackage{graphicx}   % ¡Importante! Para usar \resizebox
\usepackage{siunitx}    % Para alinear números por el punto decimal
\usepackage[justification=centering, singlelinecheck=false]{caption}


\usepackage{booktabs}  % Para líneas de tabla profesionales (\toprule, \midrule, \bottomrule)
\usepackage{siunitx}   % Para alinear números en el punto decimal (columnas S)
\usepackage{graphicx}  % Para el comando \resizebox
\usepackage{caption}   % Para un mejor control de los títulos
